...
export const authAPI = {
  ...
  emergencyReset:   (master_code, new_password)          => api("POST", "/auth/emergency-reset",    { master_code, new_password }),
  updateMasterCode: (current_master_code, new_master_code) => api("POST", "/auth/update-master-code", { current_master_code, new_master_code }),
};
